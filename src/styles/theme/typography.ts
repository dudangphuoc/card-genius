...
// body2: { fontSize: '0.875rem', fontWeight: 400, lineHeight: 1.57 },
  ...
  body2: { fontSize: '0.75rem', fontWeight: 400, lineHeight: 1.57 },
  button: { fontWeight: 500 },
  caption: { fontSize: '0.625rem', fontWeight: 400, lineHeight: 1.66 },
  subtitle1: { fontSize: '0.875rem', fontWeight: 500, lineHeight: 1.57 },
  subtitle2: { fontSize: '0.625rem', fontWeight: 500, lineHeight: 1.57 },
  overline: {
    fontSize: '0.625rem',
    fontWeight: 500,
    letterSpacing: '0.5px',
